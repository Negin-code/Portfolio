...
const Home = () => {
  return (
    <main className="grid grid-cols-4 md:grid-cols-6 lg:grid-cols-12 gap-2 min-h-screen relative w-full pt-20 lg:pt-40 lg:px-0">
      {/* Left vertical line */}
      <div className="absolute left-17 md:left-20 top-0 h-[82vh] w-[3px] bg-[#493b32]">
        <span className="absolute -left-6 md:-left-9 top-[87vh] -translate-y-1/2 rotate-[-90deg] text-lg md:text-2xl text-[#493B32] font-tan">
          2025
        </span>
      </div>
      ...
      <section className="col-span-full grid grid-cols-4 md:grid-cols-6 lg:grid-cols-12 gap-2">
        ...
        <div className="col-span-4 md:col-span-6 lg:col-span-11 text-right mt-20 mr-15 lg:mr-0">
          <h1 className="font-tan text-[3rem] sm:text-[3rem] md:text-[6rem] lg:text-[7rem] xl:text-[11rem] leading-tight">
            Hi, I'm Negin
          </h1>
        </div>
        ...
        <div className="col-span-full grid grid-cols-4 md:grid-cols-6 lg:grid-cols-12 gap-5 mt-8 mr-15 lg:mr-0">
          ...
          <div className="col-span-4 md:col-span-6 lg:col-span-12 lg:col-start-2 flex flex-row items-center justify-center lg:justify-start gap-4">
            <div className="relative max-w-[300px] md:max-w-[300px] lg:max-w-[400px]">
              <img
                src={profileImage}
        ...
        <section className="grid grid-cols-4  md:grid-cols-6 lg:grid-cols-12 lg:col-span-12 lg:col-start-2 col-span-full py-20 px-0 text-[#493B32] relative">
          ...
          <div className="md:col-span-4 lg:col-span-8 col-span-3 col-start-1 mx-10 lg:mx-0 flex items-center mb-8">
            <div className="w-[5vh] md:w-[9vh] h-[2px] bg-[#493B32]"></div>
          ...
          <div className="col-span-10 col-start-1 col-end-12 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
            ...
            <div className="bg-[#FFF7F2] p-6 flex flex-col">
              ...
              <div className="w-full h-[1px] bg-[#493B32] mb-[36px] mt-[36px]"></div>
              ...
              <div className="w-full h-[1px] bg-[#493B32] mt-[36px]"></div>
            </div>
          ...
          <div className="col-span-8 md:col-span-10 lg:col-start-2 col-start-1 flex justify-between items-center mt-8">
            ...
            <div>
              <IoIosArrowDropupCircle size={64} color="#493B32" className="mx-10 my-8 mb-0">
                <a href=""></a>
